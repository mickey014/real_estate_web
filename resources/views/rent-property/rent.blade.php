    ...
    <section class="page-header" style="background:url({{ URL('storage/page-header.jpg') }})">
      <div class="header-wrapper container">
        ...
        <ul>
          <li><a href="/">Home</a></li>
          <li>></li>
          <li><a href="{{ URL('rent') }}" class="active-page">Rent</a></li>
        </ul>  
      </div>
    </section>
    ...
    <section id="listing-page-container">
            ...
            <div class="col-md-8 left-col">
                ...
                <div class="house">
                    ...
                    <div class="house-info">
                        ...
                        <a href="{{ url('/rent').'/'.$prop->property_name_slug}}" class="listing-price-view" data-toggle="tooltip" data-placement="top" title="Quick View!">
        ...
        <div class="col-md-4 right-col">
          <div class="sidebar">
            ...
            @forelse($buy_property_sidebar as $buy_sidebar)
              <div class="sidebar-featured-prop">
                <a href="{{ url('/buy').'/'.$buy_sidebar->property_name_slug }}">
